...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Theme_244.ogg';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	{
		time: 19000,
		count: 2,
		startTimes: [1800, 7100],
		dialog: {
				Japanese: [
					"青春って、あっという間なんだよな。",
					"激しく燃え上がって、すぐに消えちゃう……この炎みたいに。"
				],
				English: [
					"Youth... it's over in the blink of an eye.",
					"It burns fiercely and fades away quickly... like this flame."
				],
				Chinese: [
					"青春，真是弹指一瞬的事物呢。",
					"激烈而跃动但又很快消失，就如同火焰一般……"
	...
	},
	{
		time: 14000,
		count: 2,
		startTimes: [1400, 6500],
		dialog: {
				Japanese: [
					"アタシも、ずっとそう思ってた。",
					"……鍛錬だけで、青春が終わっちゃうんだろうなって。"
				],
				English: [
					"I thought so too, all this time.",
					"...I figured youth would end just with training."
				],
				Chinese: [
					"我也是一直这认为的。",
					"……只有锻炼的话青春也将平淡的结束。"
	...
	},
	{
		...
		dialog: {
				...
				English: [
					...
					"Every day is fun and fulfilling."
				],
				Chinese: [
					"但是现在不同。",
					"与师傅相遇之后就变了。",
	...
	},
	{
		time: 18000,
		count: 3,
		startTimes: [1000, 6000, 12300],
		dialog: {
				Japanese: [
					"もちろん、時間は戻らないけど……。",
					"これからだって、まだまだ青春できる。",
					"炎が消えそうなら、新しい薪をくべてやればいいんだ。"
				],
				English: [
					"Of course, time can't turn back...",
					"But even from now, we can still have youth.",
					"If the flame starts to fade, just add new firewood."
				],
				Chinese: [
					"当然时光无法倒流……。",
					"就算是从现在开始也还有青春。",
					"既然像火焰一般转瞬即逝那就添加新的柴火重燃不就好了。"
				]
			}
	},
	{
		...
		dialog: {
				Japanese: [
					"だから師匠……ずっと一緒に青春してくれる……よな？"
				],
				English: [
					"So Master... will you stay with me and keep having youth... forever?"
				],
				Chinese: [
					"所以，师傅……能跟我一起过完这个青春吗？"
				]
...
const HITBOX = {
	headpat: { xMin: 690, xMax: 1470, yMin: 0, yMax: 350 },
	voiceline: { xMin: 650, xMax: 1660, yMin: 800, yMax: 1800 }
};
